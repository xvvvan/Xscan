...
class Colored:
    ...
    @staticmethod
    def green_info():
        return Style.BRIGHT+Fore.GREEN+"[VUL]"+Fore.RESET+Style.RESET_ALL
    @staticmethod
    def yel_info():
...
color = Colored()
# shiro_gadget = input(color.green("[+] gadget: "))#now.timed(de=delay) +
# print( color.red_warn() + color.red(" List of supported vulnerabilities"))
# print( color.yel_info() + color.yellow(" List of supported vulnerabilities"))